      ...
      <div className="p-4 md:p-6">
        ...
        {isForex && (
          <div className="mb-4 bg-blue-500/10 border border-blue-500/20 p-3 rounded-xl text-center">
            <p className="text-[8px] text-blue-400 font-black uppercase mb-1 tracking-widest">Configuração de Alvo</p>
            <p className="text-xs font-bold text-white uppercase italic">
              {isCall ? 'Stop no fundo e alvo 2x o stop' : 'Stop no topo e alvo 2x o stop'}
            </p>
          </div>
        )}
        ...
        <div className="mb-4 bg-slate-900/60 p-3 rounded-xl border border-white/5">
          <div className="flex justify-between text-[7px] md:text-[9px] font-black uppercase mb-1.5">
            <span className="text-emerald-400">{dynamicBuyer.toFixed(0)}% BUY PRESSURE</span>
            <span className="text-rose-400">{dynamicSeller.toFixed(0)}% SELL PRESSURE</span>
          </div>
        ...
        <div className="grid grid-cols-2 gap-2 mb-4">
          ...
          <div className="bg-slate-900/80 p-3 rounded-xl border border-white/5 text-center">
            <p className="text-[7px] text-slate-500 font-black mb-1 uppercase tracking-widest">Validade</p>
        ...
        <div className={`p-4 rounded-xl border ${isCall ? 'bg-emerald-500/5 border-emerald-500/20' : 'bg-rose-500/5 border-rose-500/20'}`}>
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[8px] font-black uppercase tracking-widest text-slate-400 italic">Leitura Sniper v12.1</span>
          </div>
