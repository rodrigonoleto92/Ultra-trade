...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose, onSelectOption }) => {
  const options = [
    { 
        ...
        <div className="flex flex-col h-full">
          <div className="p-8 border-b border-white/5 flex items-center justify-between">
            <div className="flex flex-col">
              ...
              <span className="text-lg font-black logo-gradient-text uppercase">Ferramentas</span>
            </div>
          ...
          <div className="p-8 border-t border-white/5">
            <div className="bg-blue-500/10 p-4 rounded-2xl border border-blue-500/20">
              ...
              <p className="text-[7px] text-slate-500 font-bold uppercase text-center mt-1">Confluência em Tempo Real</p>
            </div>
          </div>
        </div>
      </aside>
